...
#define TEXTURE_PSY_BIAS_OPTIMIZE_B_TOKEN "--texture-psy-bias-optimize-b"
#define PSY_BIAS_DG_TOKEN "--psy-bias-dg"
...
ConfigEntry config_entry_psy[] = {
    ...
    {SINGLE_INPUT,
     SHARPNESS_TOKEN,
     "[PSY] Bias towards block sharpness in rate distortion, default is 2 [-14 to 14]",
     set_cfg_generic_token},
    // QP scale compress
    {SINGLE_INPUT,
    ...
    {SINGLE_INPUT,
     ...
     "[PSY] Min chroma quant matrix flatness, default is 10 [0-15]",
     set_cfg_generic_token},
    {SINGLE_INPUT,
    ...
    {SINGLE_INPUT,
     ...
     "[PSY] Optimize quantization using full distortion calculation. Slow. [-2,0-2,4]",
     set_cfg_generic_token},
    {SINGLE_INPUT,
     TEXTURE_PSY_BIAS_OPTIMIZE_B_TOKEN,
     "[PSY] Optimize quantization using full distortion calculation in low variance region. Slow. [-2,0-2,4]",
     set_cfg_generic_token},
    {SINGLE_INPUT,
     PSY_BIAS_DG_TOKEN,
    ...
    {SINGLE_INPUT,
     CHROMA_GRAIN_TOKEN,
     "[PSY] Control whether chroma grain is applied when using film grain, default is 1 [0-1]",
     set_cfg_generic_token},
    {SINGLE_INPUT,
     ALT_TF_DECAY_TOKEN,
     "[PSY] Apply Tune 0/3 alt-ref TF decay tweak to any tune, default is 0 [0-1]",
     set_cfg_generic_token},
    // Termination
    {SINGLE_INPUT, NULL, NULL, NULL}};
...
ConfigEntry config_entry[] = {
    ...
    {SINGLE_INPUT, TEXTURE_PSY_BIAS_OPTIMIZE_B_TOKEN, "TexturePsyBiasOptimizeB", set_cfg_generic_token},
    {SINGLE_INPUT, PSY_BIAS_DG_TOKEN, "PsyBiasDG", set_cfg_generic_token},
